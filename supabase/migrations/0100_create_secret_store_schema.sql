...
comment on column public.secret_versions.nonce_or_iv is
    'XChaCha20-Poly1305 nonce. Must be 24 bytes and unique per retained secret version; purged nonce history is not stored in the MVP and collision avoidance relies on CSPRNG generation.';
