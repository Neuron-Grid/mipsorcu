...
const MIGRATION_990_PATH: &str = "supabase/migrations/990_add_audit_metadata_allowlist.sql";
...
fn allowlist_parity_between_rust_and_sql() {
    let migration =
        fs::read_to_string(MIGRATION_990_PATH).expect("allowlist migration should be readable");
