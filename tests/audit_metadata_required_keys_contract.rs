...
fn canonical_contracts() -> Vec<AuditMetadataContract> {
    vec![
        ...
        AuditMetadataContract {
            name: "incident_notification_sent success",
            action: AuditAction::IncidentNotificationSent,
            result: AuditResult::Success,
            metadata_json: json!({
        ...
        AuditMetadataContract {
            name: "incident_notification_sent siem buffer overflow success",
            action: AuditAction::IncidentNotificationSent,
            result: AuditResult::Success,
            metadata_json: json!({
        ...
        AuditMetadataContract {
            name: "incident_notification_failed failure",
            action: AuditAction::IncidentNotificationFailed,
            result: AuditResult::Failure,
            metadata_json: json!({
        ...
        AuditMetadataContract {
            name: "incident_notification_suppressed success",
            action: AuditAction::IncidentNotificationSuppressed,
            result: AuditResult::Success,
            metadata_json: json!({
